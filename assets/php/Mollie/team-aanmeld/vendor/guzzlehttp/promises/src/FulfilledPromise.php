 ...
 */
class FulfilledPromise implements \_PhpScoper5bf6a941d2ec8\GuzzleHttp\Promise\PromiseInterface
{
    private $value;
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        ...
        $queue = queue();
        $p = new \_PhpScoper5bf6a941d2ec8\GuzzleHttp\Promise\Promise([$queue, 'run']);
        $value = $this->value;
