<?php
  ...
  if (isset($_POST["submit"]))
  {
    ...
    if (in_array($fileActualExt, $allowed))
    {
      ...
      if ($fileerror === 0)
      {
        ...
        if ($filesize < 1000000)
        {
              ...
              strlen($lidnummer4) > 0)
          {
            ...
            //    VALUES (NULL, '$teamname', '$fileNameNew', '$captianname', $captiannummer, '$lid1', $lidnummer1, '$lid2', $lidnummer2, '$lid3', $lidnummer3, '$lid4', $lidnummer4, 0, 0, $donate)";
                ...
                {
                  header('Location: https://glrtournament.nl/pages/error.php?error=1');
                  exit();
                }
          }
          ...
          {
            header('Location: https://glrtournament.nl/pages/error.php?error=2');
            exit();
          }
        ...
        {
          header('Location: https://glrtournament.nl/pages/error.php?error=3');
          exit();
        }
      ...
      {
        header('Location: https://glrtournament.nl/pages/error.php?error=4');
        exit();
      }
    }
    else
    {
      header('Location: https://glrtournament.nl/pages/error.php?error=5');
      exit();
    }
  ...
  {
    header('Location: https://glrtournament.nl/pages/error.php?error=6');
    exit();
  }
