...
//-----------------------------------------------------------------
  ...
  $result = mysqli_query($mysqli, "SELECT * FROM GLR_teams WHERE team_behandeld = 0 AND team_betaald = 1");
  ...
  while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<td><center><img src='teamlogo/". $row['team_logo'] ."' alt='afbeelding' width='40'></center></td>";
...
//-----------------------------------------------------------------
  ...
  while ($row2 = mysqli_fetch_array($result2)) {
	...
	echo "<td><a href='teamsettings.php?id=" . $row2['team_id'] . "'><img src='img/setting.png' alt='settings' width='40'></a></td>";
    echo "<td>" . $row2['team_id'] . "</td>";
    echo "<td>" . $row2['team_naam'] . "</td>";
    echo "<td><center><img src='teamlogo/". $row2['team_logo'] ."' alt='afbeelding' width='40'></center></td>";
...
//-----------------------------------------------------------------
  ...
  while ($row3 = mysqli_fetch_array($result3)) {
    ...
    echo "<td><a href='teamsettings.php?id=" . $row3['team_id'] . "'><img src='img/setting.png' alt='settings' width='40'></a></td>";
    echo "<td>" . $row3['team_id'] . "</td>";
    echo "<td>" . $row3['team_naam'] . "</td>";
    echo "<td><center><img src='teamlogo/". $row3['team_logo'] ."' alt='afbeelding' width='40'></center></td>";
...
//-----------------------------------------------------------------
  ...
  while ($row4 = mysqli_fetch_array($result4)) {
    ...
    echo "<td><a href='teamsettings.php?id=" . $row4['team_id'] . "'><img src='img/setting.png' alt='settings' width='40'></a></td>";
    echo "<td>" . $row4['team_id'] . "</td>";
    echo "<td>" . $row4['team_naam'] . "</td>";
    echo "<td><center><img src='teamlogo/". $row4['team_logo'] ."' alt='afbeelding' width='40'></center></td>";
