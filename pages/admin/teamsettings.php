...
<html lang="en" dir="ltr">
  ...
  <body>
    <form action="teamsettingsverwerk.php" method="POST" enctype="multipart/form-data">
            ...
            <br/>
            Team member 5: <input type="text" name="lid5"  required
             value="<?php echo $row['team_lid5_naam'] ?>"><br/>
            Studentennummer lid 5: <input type="text" name="lidnummer5"  required
             value="<?php echo $row['team_lid5_nummer'] ?>"><br/>
